...
module.exports = function(RED) {
    ...
    function notficationIn(n) {
        ...
        if (RED.settings.httpNodeRoot !== false) {
            ...
            this.callback = function(req,res) {
                ...
                res._msgid = msgid;
                processResponse({res:createResponseWrapper(node,res)});
                if(req.body.retriedNotification){
                    node.send([null,{_msgid:msgid,req:req,res:createResponseWrapper(node,res),payload:req.body}]);
                } else {
    ...
    RED.nodes.registerType("onesaitplatform-notification-endpoint",notficationIn);
