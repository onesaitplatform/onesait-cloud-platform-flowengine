module.exports = function(RED) {
        ...
        this.on('input', function(msg, send, done) {
            ...
            if (this.complete === "true"){
             ...
             var args = {
                ...
                data: {  "data": JSON.stringify(msgToSend), "domainName": process.env.domain},
    ...
    RED.nodes.registerType("onesaitplatform-audit",OnesaitAudit, {
        settings: {
            debugUseColors: {
                value: false,
            },
    ...
    OnesaitAudit.logHandler = new events.EventEmitter();
    OnesaitAudit.logHandler.on("log",function(msg) {
        if (msg.level === RED.log.WARN || msg.level === RED.log.ERROR) {
            sendDebug(msg);
        }
    });
    RED.log.addHandler(OnesaitAudit.logHandler);
