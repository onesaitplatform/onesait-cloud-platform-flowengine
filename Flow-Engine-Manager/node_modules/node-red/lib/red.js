...
var onesaitPlatform = require("../../@node-red/editor-api/onesait-platform/onesait-platform-comm.js");
//End OnesaitPlatform custom code
...
module.exports = {
    ...
    init: function(httpServer, userSettings) {
		 ...
		 if (userSettings.httpAdminRoot) {
			 onesaitPlatform.setDomain(userSettings.httpAdminRoot);
		 }
