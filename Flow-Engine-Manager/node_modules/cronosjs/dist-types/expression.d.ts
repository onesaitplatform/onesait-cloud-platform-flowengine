import { DaysFieldValues, YearsField } from './parser';
...
export declare class CronosExpression implements DateSequence {
    ...
    private missingHour;
    constructor(cronString: string, seconds: number[], minutes: number[], hours: number[], days: DaysFieldValues, months: number[], years: YearsField);
