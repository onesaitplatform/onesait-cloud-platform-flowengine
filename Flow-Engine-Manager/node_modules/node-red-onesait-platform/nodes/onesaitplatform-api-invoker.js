...
module.exports = function(RED) {
    ...
    function InvokeRestApiOperation(n) {
        ...
        this.on('input', function(msg) {
            ...
            var body = JSON.stringify({ "apiName": restApiName, "apiVersion":restApiVersion, "operationName": restApiOperationName, "operationMethod":restApiOperationMethod, "operationInputParams":inputParamValues, "authentication": auth});
            console.log("DELETEEMEEMEME -- "+body);
            opts.body=body;
