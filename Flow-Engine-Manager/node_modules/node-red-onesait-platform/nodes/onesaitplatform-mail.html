<html>
 ...
 /*    function obtenerOntologiasUsuario(){
     ...
     var urlService = onesaitPlatformConfig.scriptBasePath + '/flowengine/node/services/user/files?authentication=';
  ...
  <script type="text/x-red" data-template-name="onesaitplatform-mail">
	...
	<div class="form-row">
      ...
      <input type="email" id="node-input-to" placeholder="To">
    </div>
	<div class="form-row">
  ...
  <script type="text/x-red" data-help-name="onesaitplatform-mail">
    ...
    <p><code>To</code> Email of the destination.</p>
    <p><code>Subject</code> Brief summary of the email.</p>
    <p><code>Body</code>  Content of the email.</p>
	<p><code>HTML</code>  If checked, the content will be treated as HTML.</p>
    <p><code>Filename</code> Attached file with extension (e.g. test.pdf). This is an optional field. If filled in, the content of the file should be injected to this node as a binary buffer.</p>
