...
module.exports = function(RED) {
    ...
    function HTTPRequest(n) {
        ...
        if (RED.settings.httpRequestTimeout) { 
           maxTimeout = parseInt(RED.settings.httpRequestTimeout); 
        }

        this.reqTimeout = parseInt(n.timeoutMillis,10);
        if (this.reqTimeout == null || this.reqTimeout > maxTimeout){
            this.reqTimeout = maxTimeout;
        }
        console.log("DELETEME --------- HTTP REQUEST TIMEOUT: " +this.reqTimeout);
        var prox, noprox;
