...
<script type="text/x-red" data-help-name="onesaitplatform-Rest-API-invoker">
    ...
    <p><code>Operation input params</code> List of params (query, path, body or headers) required by the Rest API operation. For each one, a value must be assigned. It can be a value from a field of the incoming message (msg.) or a fixed value (string)</p>
