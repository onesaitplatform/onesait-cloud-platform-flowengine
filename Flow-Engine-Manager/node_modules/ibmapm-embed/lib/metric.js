...
Metric.prototype.addHttpRequest = function addHttpRequest(req, responseTime) {
    ...
    if (this.requests) {
        if (!this.requests[identifier]) {
            var requestsSize = Object.keys(this.requests).length;
            if (requestsSize < maxRequestSize - 1) {
                this.requests[identifier] = new HttpRequest(req, responseTime);
            }
        } else {
            this.requests[identifier].updateResponseTime(req, responseTime);
        }
    }
};
...
Metric.prototype.getJSONAppInfo2 = function getJSONAppInfo2() {
    var jsonData = {};
    if (this.socketio_requestRate > 0) {
        jsonData['reqSummary_socketioRequestRate'] = this.socketio_requestRate;
        jsonData['reqSummary_socketioAverageResponseTime'] = this.socketio_averageResponseTime;
        jsonData['reqSummary_socketioMaxRespTime'] = this.socketio_maxRespTime;
    }
    if (this.mysql_requestRate > 0) {
        jsonData['reqSummary_mysqlRequestRate'] = this.mysql_requestRate;
        jsonData['reqSummary_mysqlAverageResponseTime'] = this.mysql_averageResponseTime;
        jsonData['reqSummary_mysqlMaxRespTime'] = this.mysql_maxRespTime;
    }
    if (this.mongo_requestRate > 0) {
        jsonData['reqSummary_mongoRequestRate'] = this.mongo_requestRate;
        jsonData['reqSummary_mongoAverageResponseTime'] = this.mongo_averageResponseTime;
        jsonData['reqSummary_mongoMaxRespTime'] = this.mongo_maxRespTime;
    }
    if (this.mqtt_requestRate > 0) {
        jsonData['reqSummary_mqttRequestRate'] = this.mqtt_requestRate;
        jsonData['reqSummary_mqttAverageResponseTime'] = this.mqtt_averageResponseTime;
        jsonData['reqSummary_mqttMaxRespTime'] = this.mqtt_maxRespTime;
    }
    if (this.mqlight_requestRate > 0) {
        jsonData['reqSummary_mqlightRequestRate'] = this.mqlight_requestRate;
        jsonData['reqSummary_mqlightAverageResponseTime'] = this.mqlight_averageResponseTime;
        jsonData['reqSummary_mqlightMaxRespTime'] = this.mqlight_maxRespTime;
    }
    if (this.leveldb_requestRate > 0) {
        jsonData['reqSummary_leveldbRequestRate'] = this.leveldb_requestRate;
        jsonData['reqSummary_leveldbAverageResponseTime'] = this.leveldb_averageResponseTime;
        jsonData['reqSummary_leveldbMaxRespTime'] = this.leveldb_maxRespTime;
    }
    if (this.redis_requestRate > 0) {
        jsonData['reqSummary_redisRequestRate'] = this.redis_requestRate;
        jsonData['reqSummary_redisAverageResponseTime'] = this.redis_averageResponseTime;
        jsonData['reqSummary_redisMaxRespTime'] = this.redis_maxRespTime;
    }
    if (this.riak_requestRate > 0) {
        jsonData['reqSummary_riakRequestRate'] = this.riak_requestRate;
        jsonData['reqSummary_riakAverageResponseTime'] = this.riak_averageResponseTime;
        jsonData['reqSummary_riakMaxRespTime'] = this.riak_maxRespTime;
    }
    if (this.memcached_requestRate > 0) {
        jsonData['reqSummary_memcachedRequestRate'] = this.memcached_requestRate;
        jsonData['reqSummary_memcachedAverageResponseTime'] = this.memcached_averageResponseTime;
        jsonData['reqSummary_memcachedMaxRespTime'] = this.memcached_maxRespTime;
    }
    if (this.oracledb_requestRate > 0) {
        jsonData['reqSummary_oracledbRequestRate'] = this.oracledb_requestRate;
        jsonData['reqSummary_oracledbAverageResponseTime'] = this.oracledb_averageResponseTime;
        jsonData['reqSummary_oracledbMaxRespTime'] = this.oracledb_maxRespTime;
    }
    if (this.oracle_requestRate > 0) {
        jsonData['reqSummary_oracleRequestRate'] = this.oracle_requestRate;
        jsonData['reqSummary_oracleAverageResponseTime'] = this.oracle_averageResponseTime;
        jsonData['reqSummary_oracleMaxRespTime'] = this.oracle_maxRespTime;
    }
    if (this.strongoracle_requestRate > 0) {
        jsonData['reqSummary_strongoracleRequestRate'] = this.strongoracle_requestRate;
        jsonData['reqSummary_strongoracleAverageResponseTime'] = this.strongoracle_averageResponseTime;
        jsonData['reqSummary_strongoracleMaxRespTime'] = this.strongoracle_maxRespTime;
    }
    if (this.postgresql_requestRate > 0) {
        jsonData['reqSummary_postgresqlRequestRate'] = this.postgresql_requestRate;
        jsonData['reqSummary_postgresqlAverageResponseTime'] = this.postgresql_averageResponseTime;
        jsonData['reqSummary_postgresqlMaxRespTime'] = this.postgresql_maxRespTime;
    }
