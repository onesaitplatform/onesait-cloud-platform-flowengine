...
module.exports = function(RED) {
    ...
    function onesaitplatformOperation(n) {
    ...
    RED.nodes.registerType("onesaitplatform api rest operation",onesaitplatformOperation);


    function onesaitplatformOperationResponse(n) {
        RED.nodes.createNode(this,n);
        var node = this;
    ...
    RED.nodes.registerType("onesaitplatform api rest operation response",onesaitplatformOperationResponse);
}
